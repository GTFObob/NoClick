...
// injecting this code into the currently open page to open a new window.
function articleTopic() {
	var code = 'var myWindow = window.open("", "MsgWindow", "width=200,height=100"); \
    				myWindow.document.write("<p> The topic of the article is: yo mum </p>");';
	chrome.tabs.executeScript({code: code});

	// The topic is split into sentences and fed to the topic modelling function.
	var sentences = topic.split("\n");
	topicise(sentences);
};
